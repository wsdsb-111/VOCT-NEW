...
const ordinary = buildKinshipGraph({
  10: { id: 10, fullName: "丙君", spouses: [11] },
  11: { id: 11, fullName: "丁氏", spouses: [10] }
});
...
assert.equal(multipleStatuses.relationBetweenOfTypes(30, 33, spouseTypes).relation.type, "DECEASED_SPOUSE_OF");
...
const deceasedCousins = buildKinshipGraph({
  ...
  43: { id: 43, fullName: "辛君", alive: true, spouse: 44 },
  44: { id: 44, fullName: "壬氏", alive: false, spouse: 43 }
});
...
const deceasedCousinResult = resolveAnchoredRelationMention({ query: "辛君的已故配偶是谁", responderId: 43, graph: deceasedCousins });
