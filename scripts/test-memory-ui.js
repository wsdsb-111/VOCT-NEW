...
try {
  ...
  assert.strictEqual(overview.engineVersion, "2.5");
...
assert(rendererSource.includes("Memory Engine 2.5 · V7.10.0"), "summary UI must expose the V7.10.0 / Memory Engine 2.5 runtime version");
