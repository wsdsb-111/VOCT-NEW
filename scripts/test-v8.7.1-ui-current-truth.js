...
for (const marker of ["这是人物当前状态，需要用 CK3 核对", "要核对哪个人物？", "要核对哪项状态？", "CK3 当前状态：", "世界记忆：", "改为过去事件", "取消当前状态声明", "隐藏此记录", "永久删除", "operation: \"delete\"", "world-memory-danger-button"]) assert.ok(source.includes(marker), `missing Current Truth UI marker: ${marker}`);
