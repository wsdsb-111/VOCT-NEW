...
run("Every shipped standard action declares valid semantic metadata", () => {
  ...
  for (const file of actionFiles) {
    ...
    const hasMatcher = Array.isArray(action.semantic.evidencePatterns) && action.semantic.evidencePatterns.length > 0 || typeof action.semantic.match === "function" || action.semantic.moneyTransfer === true;
