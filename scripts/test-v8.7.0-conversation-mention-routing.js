...
assert(source.includes("mentionedEntityIds: memory3Settings.v812MemoryEngine3Enabled !== false ? currentTurnMentionedCharacterIds : mentionedCharacterIds"), "3.0 uses current-turn Extra mentions; legacy fallback retains session mentions");
