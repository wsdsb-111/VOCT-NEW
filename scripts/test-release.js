...
const checks = [
  ...
  { group: "v7.3.1-summary-recovery", args: [path.join(__dirname, "test-v7.3.1-summary-recovery.js")] },
  { group: "v7.4-dialogue-action-cache", args: [path.join(__dirname, "test-v7.4-dialogue-action-cache.js")] },
  { group: "v7.5-memory-action-retirement", args: [path.join(__dirname, "test-v7.5-memory-action-retirement.js")] },
...
console.log(`\nVOTC v7.5 Release Regression: PASS (${checks.length} groups)`);
