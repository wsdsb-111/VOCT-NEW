...
(async () => {
  ...
  assert(settingsRepositorySource.includes('deepseekActionStablePrefixOptimization: config.deepseekActionStablePrefixOptimization !== false'), "stable-prefix must preserve explicit opt-out while defaulting on");
