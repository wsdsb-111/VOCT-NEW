...
const first = service.prepareOutboundRequest({ provider: "zhipu", model: "glm-5.3-flash", requestType: "chat", request: request(messagesA), blocks, conversationId: "conv_fixture", responderId: "123", baseUrl: "https://open.bigmodel.cn/api/paas/v4" });
const second = service.prepareOutboundRequest({ provider: "zhipu", model: "glm-5.3-flash", requestType: "chat", request: request(messagesB), blocks, conversationId: "conv_fixture", responderId: "123", baseUrl: "https://open.bigmodel.cn/api/paas/v4" });
