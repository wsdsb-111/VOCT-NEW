...
function parseRelationIntent(query = "") {
  ...
  if (!match) return { detected: false, relationTypes: [], sexConstraint: null, birthOrder: null, recency: null, anchorMention: null, sourcePhrase: null, confidence: "NONE", anchorMode: null };
  return {
    detected: true,
