...
const EXPLICIT_RECALL_INTENT = /(?:还记得|记不记得|是否记得|可记得|记得|想起|回想|之前|以前|上次|当时|曾经|那次|往日|约定|承诺|答应|说过|提到过|发生过|谁|何时|什么时候|何地|哪里|为何|为什么)/i;
...
function detectIntent(query, { entityNames = [] } = {}) {
  ...
  return { triggered: explicit || entityMatched, reason: explicit ? "explicit_recall_intent" : entityMatched ? "named_entity_query" : "no_recall_intent", explicit, entityMatched };
}

module.exports = { expandQuery, createQueryFingerprint, detectIntent, EXPLICIT_RECALL_INTENT, QUERY_ALIAS_GROUPS };
