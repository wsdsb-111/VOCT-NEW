...
清单会覆盖全部 `test-*.js`：直接发布组、动作聚合组和 follow-up 聚合组均必须登记。V7.9.3 当前登记 72 个直接发布组并覆盖 105 个测试文件；另有 172 条 AE4 Ground Truth Benchmark，供真实 Selector 与 CK3 验收结果计算 Recall、Trigger Accuracy、Per-Action Gate 和 Stop-the-Line Blocker。
